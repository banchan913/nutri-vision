...
const translations = {
    ja: {
        ...
        "dash_guide_calendar": "※詳細な日別分析や過去の記録は『カレンダー』タブから確認できます。",

        // Calendar
        "cal_selected": "分析と記録",
        "cal_select_help": "日付を選択すると詳細が表示されます",
        "cal_scope_day": "日別",
        "cal_scope_week": "週次",
        "cal_scope_month": "月次",
        "cal_scope_all": "全期間",
        ...
        "set_ai_howto_5": "最後に<strong>「テスト」</strong>ボタンを押し、成功したら表示される<strong>「推奨」のAIモデルを選択して保存</strong>してください。",
        ...
        "set_transfer_desc": "別のスマホやタブレットに設定を引き継ぐためのQRコードを表示します。手入力の手間なく、カメラで読み取るだけで設定を同期できます。",
        "set_btn_qr": "引き継ぎ用QRコードを表示",
        ...
        "msg_qr_restored": "【魔法発動】他のデバイスからの設定情報を引き継ぎました！",
